...
import { Home, SmartToy } from '@mui/icons-material';

const navItems = [
    { name: 'Home', path: '/', icon: <Home fontSize="small" /> },
    { name: 'Archive Assistant', path: '/chat', icon: <SmartToy fontSize="small" /> }
];
            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/" className="text-white hover:text-white/90 transition-colors">
                        <h1 className="text-xl md:text-2xl font-bold font-montserrat">Ferrè Archive</h1>
                    </Link>
